...
### 4. **Android System Bar Styling**
- Automatic status bar and navigation bar color management
...
<!-- Navigation bar (MAUI top bar with back button) -->
...
4. **Navigation issues**: Verify PageNavigationService usage
...
- ? Use `PageNavigationService` for all navigation
...
- ? Don't mix navigation methods (use PageNavigationService consistently)
